...
<!--chapter:end:02-bivariate-simulation.Rmd-->
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -1.6804 -0.3937  0.2515  0.4189  1.2623 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)  
## (Intercept)  -0.5444     0.3848  -1.414   0.1949  
## group_d       1.0981     0.5443   2.018   0.0783 .
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.8605 on 8 degrees of freedom
## Multiple R-squared:  0.3373,	Adjusted R-squared:  0.2544 
## F-statistic: 4.071 on 1 and 8 DF,  p-value: 0.07834
```
...
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)  
## (Intercept)   0.5538     0.3848   1.439   0.1881  
## group_d      -1.0981     0.5443  -2.018   0.0783 .
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
...
## season       3   11.0   3.668   0.297  0.827
## Residuals   16  197.6  12.350
```
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.8004 -2.8780  0.3451  2.5614  5.7127 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept) 102.7073     1.5716  65.352   <2e-16 ***
## V1            1.2055     2.2226   0.542    0.595    
## V2           -0.8290     2.2226  -0.373    0.714    
## V3            0.5037     2.2226   0.227    0.824    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.514 on 16 degrees of freedom
## Multiple R-squared:  0.05275,	Adjusted R-squared:  -0.1249 
## F-statistic: 0.297 on 3 and 16 DF,  p-value: 0.827
```
...
<!--chapter:end:03-multiple-regression.Rmd-->
...
<!--chapter:end:04-interactions.Rmd-->
...
<!--chapter:end:05-linear-mixed-effects-intro.Rmd-->
...
<!--chapter:end:06-linear-mixed-effects-one.Rmd-->
...
<!--chapter:end:07-crossed-random-factors.Rmd-->
...
<!--chapter:end:08-generalized-linear-models.Rmd-->
